        ...
        <div className="Content">
          <div className="DescriptionContainer">
            ...
            <p>
              ...
              whether personally or on behalf of an entity (“you”) and all the
              contributors of the Djed Alliance (“we," “us," or “our”), concerning your
              access to and use of the Djed Stablecoin protocol, including its smart
              contracts (the "Smart Contracts") and the djed.one web interface (the
              “Interface” or "Site") (collectively, "Djed").
            </p>
            <p>
              You agree that by using Djed, you have read, understood, and agreed to be
              bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE
              TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING DJED AND YOU MUST
            ...
            <p>
              ...
              Please ensure that you check the applicable Terms every time you use Djed so
              that you understand which Terms apply. You will be subject to, and will be
              deemed to have been made aware of and to have accepted, the changes in any
              revised Terms of Use by your continued use of Djed after the date such
              revised Terms of Use are posted.
            </p>
            <p>
              Djed is not intended for use by any person or entity in any jurisdiction or
              country where such use would be contrary to law or regulation or which would
              subject us to any registration requirement within such jurisdiction or
              country. Accordingly, those persons who choose to use the Protocol or the
              Interface from such locations do so on their own initiative and are solely
            ...
            <p>
              ...
              to use Djed. If you are a minor, you must have your parent or guardian read
              and agree to these Terms of Use prior to you using Djed.
            </p>
            <h3>2. User Representations</h3>
            <p>
              By using Djed, you represent and warrant that: (1) you have the legal
              ...
              received parental permission to use Djed; (3) you will not use Djed for any
              illegal or unauthorized purpose; and (4) your use of Djed will not violate
              any applicable law or regulation.
            </p>
            <h3>3. Prohibited Activities</h3>
            <p>
              You may not access or use Djed for any purpose other than that for which we
              make Djed available. Djed may not be used in connection with any commercial
              endeavors except those that are specifically endorsed or approved by us.
            </p>
            <p>As a user of Djed, you agree not to:</p>
            <ul>
              <li>
                Trick, defraud, or mislead us and other users, especially in any attempt
                to learn sensitive account information such as user passwords or private
                keys.
              </li>
              <li>
                Circumvent, disable, or otherwise interfere with security-related features
                of Djed, including features that prevent or restrict the use or copying of
                any Content or enforce limitations on the use of Djed and/or the Content
                contained therein.
              </li>
              <li>
                Disparage, tarnish, or otherwise harm, in our opinion, us and/or Djed.
              </li>
              <li>
                Use any information obtained from Djed in order to harass, abuse, or harm
                another person.
              </li>
              <li>
                Use Djed in a manner inconsistent with any applicable laws or regulations.
              </li>
              <li>
                ...
                use and enjoyment of Djed or modifies, impairs, disrupts, alters, or
              ...
              <li>
                Interfere with, disrupt, or create an undue burden on Djed or the networks
                or services connected to Djed.
              </li>
              <li>
                Harass, annoy, intimidate, or threaten any of our contributors engaged in
                providing any portion of Djed to you.
              </li>
              <li>
                Attempt to bypass any measures of Djed designed to prevent or restrict
                access to Djed, or any portion of Djed.
              </li>
              <li>
                Copy or adapt Djed’s software in ways that violate that software's
                license.
              </li>
              <li>
              ...
              <li>
                ...
                reader that accesses Djed, or using or launching any unauthorized script
                or other software.
              </li>
            </ul>
            <h3>4. Submissions</h3>
            <p>
              ...
              feedback, or other information regarding Djed ("Submissions") provided by
            ...
            <h3>5. Site Management</h3>
            <p>
              We reserve the right, but not the obligation, to: (1) monitor Djed for
              ...
              authorities; and (3) otherwise manage Djed in a manner designed to protect
              our rights and property and to facilitate the proper functioning of Djed.
            </p>
            <h3>6. Privacy Policy</h3>
            <p>
              We care about data privacy and security. Djed does not collect any personal
              data. Transactions interacting with the Smart Contracts are publicly
              registered on the blockchain and the wallet addresses and the balances on
              these addresses are visible. By using Djed, you agree that you understand
              how such data is stored on blockchains and you accept the storage of such
              data on the blockchain.
            </p>
            <h3>7. Term and Termination</h3>
            <p>
              These Terms of Use shall remain in full force and effect while you use Djed.
              WITHOUT LIMITING ANY OTHER PROVISION OF THESE TERMS OF USE, WE RESERVE THE
              RIGHT TO, IN OUR SOLE DISCRETION AND WITHOUT NOTICE OR LIABILITY, AND TO THE
              EXTENT THAT IT IS TECHNOLOGICALLY FEASIBLE, DENY ACCESS TO AND USE OF THE
              INTERFACE (INCLUDING BLOCKING CERTAIN ADDRESSES), TO ANY PERSON FOR ANY
              ...
              ANY APPLICABLE LAW OR REGULATION. WE MAY TERMINATE YOUR USE OF THE
              INTERFACE, WITHOUT WARNING, IN OUR SOLE DISCRETION.
            </p>
            ...
            <p>
              We also reserve the right to modify or discontinue the Interface without
              notice at any time. We will not be liable to you or any third party for any
              modification, price change, suspension, or discontinuance of the Interface.
            </p>
            <p>
              The Smart Contracts run autonomously on the blockchain and the operation of
              the blockchain is not performed by us, but by the blockchain validator
            ...
            <p>
              ...
              operate the oracles. We will not be liable to you or any third party for any
              problems in the oracles, including without limitation: oracle delays,
              unavailability of the oracle, wrong data provided by the oracle.
            </p>
            <p>
              We do not guarantee Djed will be available at all times. We may experience
              hardware, software, or other problems or need to perform maintenance related
              to Djed, resulting in interruptions, delays, or errors. We reserve the right
              to change, revise, update, suspend, discontinue, or otherwise modify Djed at
              ...
              inability to access or use Djed during any downtime or discontinuance of the
              Site. Nothing in these Terms of Use will be construed to obligate us to
              maintain and support Djed or to supply any corrections, updates, or releases
              in connection therewith.
            </p>
            <h3>9. Dispute Resolution</h3>
            <p>
              You hereby accept the non-territorial self-sovereign and autonomous nature
              of Djed and waive any and all rights to, and hereby covenants not to, bring
              any lawsuit, arbitration or other proceeding in any jurisdiction, judicial
              body or forum arising under or relating to these Terms of Use or the use of
              Djed.
            </p>
            ...
            <h3>11. Disclaimer</h3>
            <p>
              DJED IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE
              OF DJED WILL BE AT YOUR SOLE RISK. TO THE FULLEST EXTENT PERMITTED BY LAW,
              WE DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, IN CONNECTION WITH DJED AND
              ...
              DJED, (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY
              AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION STORED THEREIN,
              (4) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM THE SITE, (5)
              ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR
              THROUGH DJED BY ANY THIRD PARTY, AND/OR (6) ANY ERRORS OR OMISSIONS IN ANY
            ...
            <p>
              ...
              ARISING FROM YOUR USE OF DJED, EVEN IF WE HAVE BEEN ADVISED OF THE
              ...
              REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO $0.00
              USD.
            </p>
            ...
            <p>
              ...
              any third party due to or arising out of: (1) use of Djed; (2) breach of
              ...
              overt harmful act toward any other user of Djed with whom you connected via
              your use of Djed. Notwithstanding the foregoing, we reserve the right, at
            ...
            <h3>14. User Data</h3>
            <p>
              We will maintain no data about your use of Djed. Your use of Djed may cause
              transactions to be registered on a blockchain. You agree that we shall have
            ...
            <h3>15. Electronic Communications, Transactions, and Signatures</h3>
            <p>
              Using Djed, sending us emails or messages through Discord, and completing
              ...
              email and on Djed, satisfy any legal requirement that such communication be
              ...
              AND RECORDS OF TRANSACTIONS INITIATED OR COMPLETED BY US OR VIA THE USE OF
              DJED. You hereby waive any rights or requirements under any statutes,
            ...
            <p>
              ...
              Site or in respect to Djed constitute the entire agreement and understanding
              ...
              a result of these Terms of Use or use of Djed. You agree that these Terms of
